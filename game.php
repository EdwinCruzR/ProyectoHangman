...
$resultado2 = mysqli_query($conexion, "SELECT * FROM words WHERE id = '$verbRand'");
...
<body>
    ...
    <div class="action" onclick="actionToggle();">
            ...
            <ul>
                ...
                <br>
                <li><a href="index.html">Rendirse</a></li>
            </ul>
        </div> <br>

    <div class="container show">
        <img src="./img/baseH.png" width="200" height="300" class="baseH">
        <img src="./img/head.png" width="200" height="300" class="headH">
        <img src="./img/body.png" width="200" height="300" class="bodyH">
        <img src="./img/ArmL.png" width="200" height="300" class="armLH">
        <img src="./img/ArmR.png" width="200" height="300" class="armRH">
        <img src="./img/LegL.png" width="200" height="300" class="legLH">
        <img src="./img/LegR.png" width="200" height="300" class="legRH">
