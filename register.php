...
if (isset($_POST["registro"])) {
    ...
    if (!empty($_POST['nombre']) && !empty($_POST['apellido']) && !empty($_POST['escuela']) && !empty($_POST['email']) && !empty($_POST['password'])) {
        ...
        $host = "65.99.225.56";
        $dbuser = "cbtised3_hangman";
        $dbpassword = "vGVWQ_Ljlm*K";
        $dbname = "cbtised3_hangman";
...
<body>
    ...
    <form method="post" class="form">
        ...
        <p class="formParagraph">¿Ya tienes una cuenta? <a href="signUp.php" class="formLink">Inicia Sesión</a></p>
        <div class="formContainer">
            ...
            <input type="submit" class="formSubmit" name="registro" value="Registrar">
        </div>
    </form>
